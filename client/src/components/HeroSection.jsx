        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="bg-blue-50 rounded-3xl shadow-xl p-6 md:p-8 flex flex-col md:flex-row relative md:h-[500px]">
            ...
            <div className="w-full md:w-1/2 mt-4 md:mt-0">
              <img src="../assets/properties/area1.jpg" alt="House with trees" className="w-full h-[250px] md:h-full object-cover rounded-lg" />
            </div>
          </div>
  
          {/* Search Bar */}
          <div className="bg-white shadow-lg rounded-2xl p-4 md:p-6 flex flex-wrap justify-between items-center space-y-2 md:space-y-0 -mt-8 md:-mt-16 relative z-20 w-full md:w-11/12 mx-auto">
