...
const listings = [
  { img: "/assets/agents/agent02.webp", title: "Lily Bicharm", text: "Lily Bicharm is a dedicated and professional real estate agent..." },
  { img: "/assets/agents/agent05.webp", title: "Lily Bicharm", text: "Lily Bicharm is a dedicated and professional real estate agent..." },
  { img: "/assets/agents/agent02.webp", title: "Lily Bicharm", text: "Lily Bicharm is a dedicated and professional real estate agent..." },
];
...
const Realsgent = () => {
  return (
    <div className="px-4 sm:px-6 pt-14 bg-gray-100 min-h-[60vh]">
      <h1 className="text-center text-2xl sm:text-3xl font-semibold">Real Estate Agents</h1>
      <p className="text-center text-gray-600 mt-2">
        Discover the best properties available in prime locations.
      </p>

      {/* Container for Cards */}
      <div className="flex flex-wrap justify-center gap-6 mt-6">
        {listings.map((item, index) => (
          <AgentCard key={index} img={item.img} title={item.title} listing={item.text} />
        ))}
      </div>
    </div>
  );
